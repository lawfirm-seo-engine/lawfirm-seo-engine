...
${td.label} 사기는 ${td.approach} 방식을 통해 피해자를 끌어들입니다. 피해자는 처음에 ${td.victimAction}을 요청받고, 신뢰가 쌓인 뒤 점차 ${td.mechanism} 명목으로 금전을 요구받습니다.
...
${plainName} 관련 피해가 의심된다면 아래 순서로 대응하는 것이 효과적입니다.
